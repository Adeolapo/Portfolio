...
const Onboard = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => setFadeOut(true), 10000); // Duration before hiding
    ...
    return (
    <div>
        <div className={`b-[url(/Rectangle232.svg)] b-cover h-[100vh] w-[100vw] flex items-center justify-center ${fadeOut ? "fade-out" : ""} `}>
        <StarBackground />
        
           <TypingAnimation className='text-4xl font-bold' words={["Bonjour le monde!", "Hola mundo!", "Hello World!"]} typeSpeed={50} deleteSpeed={70} loop={false} />
        </div>
