...
const StarBackground = () => {
    ...
    return (
        ...
        <div ref={robotRef} className="relative w-full h-full pointer-events-none z-20 ">
            <img ref={robotRef} src={rock} alt="" className="absolute left-0 bottom-0 w-[30%] z-10  " />
            <img src={rock} alt="" className="absolute left-[25%] bottom-0 w-[20%]  " />
            <img src={rock} alt="" className="absolute left-[40%] bottom-0 w-[18%]  " />
            <img src={rock} alt="" className="absolute left-[50%] bottom-0 w-[18%]  " />
            <img src={rock} alt="" className="absolute left-[60%] bottom-0 w-[18%]  " />
            <img src={rock} alt="" className="absolute left-[70%] bottom-0 w-[27%]  " />
            <img src={rock} alt="" className="absolute left-[90%] bottom-0 w-[23%]  " />
